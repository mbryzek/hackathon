...
<Shell title="Program Ad Space">
  <div class="max-w-3xl mx-auto px-4 py-8 pb-24 space-y-12 text-lg leading-relaxed">
    ...
    <div>
      ...
      <div class="flex gap-2 mb-4">
        {#each sizes as size, i}
          <button
            class="px-3 py-1.5 rounded-lg text-sm font-medium transition-colors {encouragementSize === i
      ...
      <div
        class="border-2 rounded-lg p-4 flex flex-col items-center justify-center mx-auto overflow-hidden"
      ...
      >
        <div class="text-center" style="max-width: 180px;">
          ...
          {:else if encouragementSize === 1}
            <p class="text-xs text-gray-700 italic mt-1">We're so proud of everything you've built. Show them what you've got!</p>
    ...
    <div>
      ...
      <p class="text-gray-600 font-light mb-4">Here's an example of what an encouragement ad with photo.</p>
    ...
    <div>
      ...
      <div class="flex gap-2 mb-4">
        {#each sizes as size, i}
          <button
            class="px-3 py-1.5 rounded-lg text-sm font-medium transition-colors {businessSize === i
              ? 'bg-gray-900 text-white'
              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}"
  ...
  <div class="fixed bottom-0 left-0 right-0 bg-yellow-50 border-t-2 border-yellow-400 py-3 px-4 text-center z-50">
    <div class="flex items-center justify-center gap-3">
      <p class="text-gray-900 font-semibold text-sm sm:text-base">Deadline has passed. Support your students with a donation.</p>

<script lang="ts">
  ...
  const topAwards: Award[] = [
    {
      title: '1st Place',
      prize: '$1,000',
      description: 'Highest number of points in judging criteria. Any ties are broken by the judges.'
    },
    {
      title: '2nd Place',
      prize: '$500',
      description: '2nd highest number of points based on judging criteria. Any ties are broken by the judges.'
    },
    {
      title: '3rd Place',
      prize: '$250',
      description: '3rd highest number of points based on judging criteria. Any ties are broken by the judges.'
    }
  ];
  ...
  const additionalAwards: Award[] = [
    ...
    },
    {
      ...
      prize: '$250',
      description: 'Awarded to the team with the highest number of points with all members in their first year of high school.'
    },
    {
      title: 'Cybersecurity',
      prize: '$250',

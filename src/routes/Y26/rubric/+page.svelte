<script lang="ts">
  ...
  const presentationRubric = [
    {
      score: '+1',
      description: 'Clear & Engaging - The team clearly explains what they built, why it matters, and demonstrates it working.'
    },
    {
      score: '0',
      description:
  ...
  <div class="flex flex-col gap-y-8">
    ...
    <div>
      ...
      <div class="space-y-3 text-gray-800 font-light">
        <p>
          ...
          project to see what other teams have built. During this period, judges will evaluate each team's work against the rubric.
        </p>
        <p>
          The maximum number of points a single judge can award to a single team is 11. Maximum penalty is -2. Each team's score will be an
          average across all of the judges. Judges who have a child on a particular team will be excused from evaluating that team.
        </p>
        <p>
          The criteria are intended to be applied equally to all teams - team backgrounds, reputation, and skill levels do not influence
          scoring.
        </p>
        <p>The top 3 teams will be invited to present for the full audience - and then prizes will be announced.</p>
      </div>
    </div>
    ...
    <div class="rounded-lg border border-blue-200 bg-blue-50 px-6 py-4">
      ...
      <p class="text-sm text-blue-700">
        ...
        is built as possible negative points based on understanding.
      </p>
    </div>
  </div>
</Shell>

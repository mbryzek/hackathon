...
export const overallPrizes: Prize[] = [
  {
    title: '1st Place',
    amount: '$1,000 Cash',
    description: 'Highest # of points in judging criteria. Any ties are broken by the judges.'
  },
  {
    title: '2nd Place',
    amount: '$500 Cash',
    description: '2nd highest # of points based on judging criteria. Any ties are broken by the judges.'
  },
  {
    title: '3rd Place',
    amount: '$250 Cash',
    description: '3rd highest # of points based on judging criteria. Any ties are broken by the judges.'
  }
];
...
export const additionalPrizes: Prize[] = [
  {
    ...
    amount: '$500 Cash',
    description: 'Awarded to the team with the highest # of points that has built a native mobile application (android or iOs).'
  },
  {
    title: 'Cybersecurity',
    amount: '$500 Cash',
  ...
  },
  {
    ...
    amount: '$250 Cash',
    description: 'Awarded to the team with the highest # of points with all members in their first year of high school.'
  },
  {
  ...
  },
  {
    ...
    amount: '$250 Cash',
    description: 'The idea here is to encourage students to build robotic, arduino, etc devices / products'
  },
  {

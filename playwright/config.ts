...
export const config: TestConfig = {
  ...
  FRONTEND_BASE_URL: process.env.FRONTEND_BASE_URL || process.env.BASE_URL || 'http://localhost:5173',
  ...
  SCREENSHOTS: {
    ...
    path: process.env.TEST_RUN_DIR ? `${process.env.TEST_RUN_DIR}/screenshots` : '/tmp/playwright-screenshots', // Fallback for backward compatibility
    fullPage: true
  }
};
